            ...
            <div className='md:grid sm:grid-cols-3 gap-12 justify-center items-center'>
                ...
                <div className='sm:col-span-2 flex flex-col glassing text-base p-8 font-light border border-solid border-gray-900/10 dark:border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.1)] dark:shadow-[0_4px_30px_rgba(255,255,255,0.2)] gap-4'>
                    <p>
                        ...
                        I&apos;ve delved into frontend development, taking on diverse projects in a short span.
                    </p>
                    <p>
                        I&apos;ve contributed significantly to various projects, including
                        <strong className='font-bold'> migrating 100+ websites from Drupal to NextJS</strong> with
                        Kontent.ai&apos;s Headless CMS for Elanco. My toolkit — TypeScript, React, NextJS, TailwindCSS —
                        ensured top-tier frontend components.
                    </p>
                    <p>
